...
namespace BadmintonCourtManagement.GUI
{
    public partial class FormhoadonDetail : Form
    {
        ...
        public FormhoadonDetail(string billBookingId, AccountDTO? account = null)
        {
        ...
        private void LoadBillDetail()
        {
            try
            {
                ...
                var bill = hoadonBUS.GetById(_billId);
                ...
                // Dùng enum đúng cách
                string statusText = bill.Status == hoadonDTO.BookingStatus.played ? "Đã chơi" : "Đã đặt sân";
